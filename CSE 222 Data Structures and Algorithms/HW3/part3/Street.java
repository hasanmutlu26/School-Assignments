public class Street{
    ...
    private LDLinkedList<Land> RHS;
    private LDLinkedList<Land> LHS;

    public Street(){
        this.length = 0;
        this.RHS = new LDLinkedList<Land>();
        this.LHS = new LDLinkedList<Land>();
    }
    ...
    public String listAll(){
        ...
        temp.append("\nLeft side of the street:\n");
        for(int i = 0; i < LHS.size(); i++){
            temp.append((i+1) + ": " + LHS.get(i).getClass().getSimpleName() + "\n");
        }
        temp.append("\nRight side of the street:\n");
        for(int i = 0; i < RHS.size(); i++){
            temp.append((i+1) + ": " + RHS.get(i).getClass().getSimpleName() + "\n");
        }
        return temp.toString();
    }

    /**
     * This function gives a basic list of deleted buildings.
     * @return basic list of deleted buildings as String.
     */
    public String listDeletedBuildings(){
        StringBuilder temp = new StringBuilder();
        temp.append("\nBuildings removed from left side of the street:\n");
        for(int i = 0; i < LHS.deletedSize(); i++){
            temp.append((i+1) + ": " + LHS.getDeleted(i).getClass().getSimpleName() + "\n");
        }
        temp.append("\nBuildings removed from right side of the street:\n");
        for(int i = 0; i < RHS.deletedSize(); i++){
            temp.append((i+1) + ": " + RHS.getDeleted(i).getClass().getSimpleName() + "\n");
        }
        return temp.toString();
    }

    /**
     * This function gives a detailed list of deleted buildings.
     * @return detailed list of deleted buildings as String.
     */
    public String detailedListDeleted(){
        StringBuilder temp = new StringBuilder();
        temp.append("\nBuildings deleted from left side of the street:\n");
        for(int i = 0; i < LHS.deletedSize(); i++){
            temp.append(LHS.getDeleted(i).toString() + "\n\n");
        }
        temp.append("Buildings deleted from right side of the street:\n");
        for(int i = 0; i < RHS.deletedSize(); i++){
            temp.append(RHS.getDeleted(i).toString() + "\n\n");
        }
        return temp.toString();
    }
