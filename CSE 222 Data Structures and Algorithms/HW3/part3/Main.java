...
public class Main{
    ...
    public static void main(String args[]){
        ...
        System.out.println("Running time of driver function in LDLinkedList version is " + (stopTime - startTime) + " nanoseconds.\n");
    ...
    public void driverFunction(){
        ...
        System.out.println("------------------------------------------------------------------------------");
        System.out.println("List of deleted buildings:");
        System.out.println(st.listDeletedBuildings());
        System.out.println("------------------------------------------------------------------------------");

        System.out.println("\n\n------------------------------------------------------------------------------");
        System.out.println("Detailed list of deleted buildings:");
        System.out.println(st.detailedListDeleted());
        System.out.println("------------------------------------------------------------------------------");

        System.out.println("\n\n------------------------------------------------------------------------------");
        System.out.println("Add deleted buildings again and list again:");
        System.out.println("Add the deleted Market(15, 10, 10, \"Zeynep Hanim\", 10, 21)");
        System.out.println("Add the deleted playground Playground(55, 20)");
        st.add(2, new Market(15, 10, 10, "Zeynep Hanim", 10, 21));
        st.add(1, new Playground(55, 20));
        System.out.println("Detailed list of street:");
        System.out.println(st.toString());
        System.out.println("Detailed list of deleted buildings:");
        System.out.println(st.detailedListDeleted());
        System.out.println("------------------------------------------------------------------------------");
    ...
    private void viewMode(){
        ...
        while(true){
            ...
            System.out.println("7. Display the deleted buildings.");
    ...
    private void displayDeletedList() {
        int selection;
        System.out.println("\nYou have selected to display list of deleted buildings.");
        System.out.println("Do you want to see a detailed list or a basic list?");
        System.out.print("1. Detailed\n2. Basic\nSelection: ");
        selection = readInput();
        switch(selection){
